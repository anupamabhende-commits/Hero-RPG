...
public class PlayerController : MonoBehaviour
{
    ...
    public Vector3 PlanarVelocity => lastPlanarVelocity;
    ...
    private void Update()
    {
        ...
        bool sprinting = input.SprintHeld && input.Move.sqrMagnitude > 0.01f && !actionLocked;
    ...
    private void EnsureModules()
    {
        ...
        {
            combat.spellController = GetComponent<PlayerSpellController>();
        }
